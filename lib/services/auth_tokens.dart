...
class AuthTokens {
  ...
  static String accessTokenKey = 'diatribapp-access-token';
  static String refreshTokenKey = 'diatribapp-refresh-token';
  ...
  static Future<void> updateTokenToLatest() async {
    ...
    final tokens = await SpotifyAuthApi.getNewTokens(originalTokens: savedTokens);
